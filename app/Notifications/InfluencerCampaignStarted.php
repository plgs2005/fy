...
class InfluencerCampaignStarted extends Notification implements ShouldBroadcast
{
    use Queueable;
    ...
    public function __construct($user, $campaign)
    {
        ...
        $this->url = 'home';
        $this->message = 'Hey <b>'.$this->user->name.'!</b><br><b>'.$this->campaign->name.'</b> campaign has started.<br>Add your post link in Active Campaigns and mark as complete.';
    }
    ...
    public function toSendGrid($notifiable)
    {
        return (new SendGridMailMessage)
            ...
            ->sendgrid(
                ...
                'template_id' => 'd-1b3794485cf54339a8493f26fee2059d',
                ]
            )
            ->error();
    }
